...
const toggleBars = document.querySelectorAll(".bar");

toggleButton.addEventListener("click", () => {
  navbarLinks.classList.toggle("active");
  navbarLinks.classList.toggle("inactive");
  toggleBars[1].classList.toggle("x-form");
  toggleBars[0].classList.toggle("drop-right");
  toggleBars[2].classList.toggle("drop-left");
});
...
class simpleImageSlider {
  ...
  constructor(
    ...
    this.slideLeftButton.addEventListener("click", () => {
      ...
      /* console.log(`leftSideImageIndex: ${this.leftSideImageIndex}  centralImageIndex: ${this.centralImageIndex}  rightSideImageIndex: ${this.rightSideImageIndex}`); */
      this.leftSideImage.setAttribute(
        "src",
        this.imageUrlsArray[this.leftSideImageIndex]
      );
      this.centralImage.setAttribute(
        "src",
        this.imageUrlsArray[this.centralImageIndex]
      );
      this.rightSideImage.setAttribute(
        "src",
        this.imageUrlsArray[this.rightSideImageIndex]
      );
    });
...
const piercingUrls = [
  "images/piercings/piercing_1.jpg",
  "images/piercings/piercing_2.jpg",
  "images/piercings/piercing_3.jpg",
  "images/piercings/piercing_4.jpg",
];
const leftPiercingImage = document.querySelector(
  ".immagine_piercing:first-child"
);
const centralPiercingImage = document.querySelector(
  ".immagine_piercing:nth-child(2)"
);
const rightPiercingImage = document.querySelector(
  ".immagine_piercing:last-child"
);

let piercingSlider = new simpleImageSlider(
  leftPiercingButton,
  rightPiercingButton,
  leftPiercingImage,
  centralPiercingImage,
  rightPiercingImage,
  piercingUrls
);
...
let slideIndex = 0;
automaticSlideshow();
setInterval(automaticSlideshow, 2500);
